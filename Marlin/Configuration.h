...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,394,93.44} // CL: default steps for _my_ HIC i3, you may need to change the Z and/or E for your machine
...
#define DEFAULT_MAX_FEEDRATE   {160,160,3,100} // (mm/sec) CL: default for _my_ HIC i3 max feedrate rated at ~120mm/sec
...
#define DEFAULT_MAX_ACCELERATION   {3000,3000,40,5000} // (mm/sec^2) CL: for _my_ HIC i3 - X, Y, Z, E(moves) maximum start speed for accelerated moves
...
#define DEFAULT_ACCELERATION   3000 // (mm/sec^2 ) CL: for _my_ HIC i3 - X, Y, Z and E max acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000 // (mm/sec^2) E acceleration for retracts (fliament purge and feed)
#define DEFAULT_TRAVEL_ACCELERATION   3000 // (mm/sec^2) X, Y, Z acceleration for travel (non-printing) moves

// The speed change that does not require acceleration (i.e. the software might assume it can be done instantaneously)
// default jerk values for HIC i3 ={20.0, 0.4, 5.0} (mm/sec)
#define DEFAULT_XYJERK              20 // CL: For HIC i3, was =20, (mm/sec)
#define DEFAULT_ZJERK                 0.4  // (mm/sec)
